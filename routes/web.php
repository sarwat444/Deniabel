...
Route::match(['get' , 'post'] ,  '/forgot-password' ,  'UsersController@forgetpassword');
...
Route::group(['middleware' => ['adminlogin']], function () {
	...
	//Admin View Innnovice  

	Route::get('/admin/view-innovice/{id}','ProductsController@viewInnoviceOrder');
